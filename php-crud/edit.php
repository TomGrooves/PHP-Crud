...
<form class="theForm" action="" method="post">
    <!--
        <label for="username"><span class="error">* <?php echo $nameErr;?></span></label>
        <input placeholder=Brugernavn type="text" name="username" id="username">
        <label for="password"><span class="error">* <?php echo $nameErr;?></span></label>
        <input placeholder="Password" type="text" name="password" id="password">
        <label for="emailaddress"><span class="error">* <?php echo $nameErr;?></span></label>
