...
// Så længe brugeren ikke trykker "bekræft".
    ...
    echo "<div class='create3'><a class='center-div1' name='delete' href='../php-crud/delete.php?ID=".$row['id']."&confirmed=true'><button class='buttonInput2 havartiOst'>Fjern bruger</button></a></div>";
